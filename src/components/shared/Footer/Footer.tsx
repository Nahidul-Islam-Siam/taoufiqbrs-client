    ...
    <footer className="bg-black text-white nunito">
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          {/* Quick Links */}
          <div>
            <h3 className="text-[#328736]  font-normal md:text-lg text-base  mb-4">
              Quick Links
            </h3>
            <ul className="space-y-2">
              <li>
                <Link
                  href="#"
                  className="text-gray-300 md:text-base text-sm font-normal hover:text-white transition-colors"
                >
                  Home
                </Link>
              </li>
      ...
      <div className="border-t border-gray-800">
        <div className="container mx-auto px-6 py-4">
          <p className="text-center text-white text-base">
            All rights reserved @Saveurs Provençales 2025
          </p>
        </div>
      </div>
    </footer>
